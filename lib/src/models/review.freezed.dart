...
class _$Review$Impl extends Review$ {
  ...
  @override
  String toString() {
    return 'Review(id: $id, text: $text, uid: $uid, createdAt: $createdAt, photoId: $photoId)';
  }
...
abstract class Review$ extends Review {
  const factory Review$(
      {required final String id,
      required final String text,
      required final String uid,
      required final DateTime createdAt,
      required final String photoId}) = _$Review$Impl;
  const Review$._() : super._();
